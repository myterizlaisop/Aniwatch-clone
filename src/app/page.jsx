          ...
          <div className="max-w-[1440px] max-h-[70px] mx-auto flex bg-black ">
            ...
            <div>
              <div className="bg-yellow-400 rounded-md w-[70px] h-[40px] flex content-center absolute right-80 mt-[10px]">
                <button className="ml-[10px]">Login button</button>
              </div>
            </div>
          </div>
              ...
              <div className=" pl-6">
                ...
                <div className="relative">
                  ...
                  <p className="text-sm w-[760px] mb-6 line-clamp-3">
                    Eiji Kitahama, a second-year high school student, just wants
                    to be popular. To help him realize this dream, Rin Nanakura,
                    his junior in the drama club, uses her acting skills to
                    create a harem of loving girls for him. Though the various
                    “girls” all show fondness toward Eiji, the affection of the
                    actress.
                  </p>
                </div>
